...
# shift
data_tmp = data 
data_tmp[,daily_avg_After_5day:=shift(daily_avg,predict_days,type="lead")]
newdata = data_tmp[is.na(daily_avg_After_5day),]
xydata = data_tmp[!is.na(daily_avg_After_5day),]
...
# set x and y 
x = colnames(data_hex)[colnames(data_hex) %ni% c('date','daily_avg_After_5day')]
y = 'daily_avg_After_5day'
...
YHAT_list[['daily_avg_After_5day']] = data.table(date=as.character(new_date),price=forecasted_BTC$predict)

# Ãâ·Â
cat(">> 205_BTC200_ML done! \n")
